# vwap_ma_strategy/plot_trade_analysis_fixed.py
"""
Fixed Trade Visualization - Proper timezone handling for correct candle alignment
"""
...
class TradeVisualizerFixed:
    ...
    def load_price_data(self, symbol):
        ...
        try:
            ...
            # Handle timezone properly - remove timezone info for consistency
    ...
    def plot_trade_fixed(self, trade, price_df, symbol, category, rank):
        ...
        # Get trade timestamps (already timezone-naive)
    ...
    def generate_fixed_charts(self, max_trades=5):  # Start with fewer for testing
...
def run_fixed_visualization():
    """Run the fixed visualization with proper time alignment"""
    print("🎯 FIXED TRADE VISUALIZATION - PROPER TIME ALIGNMENT")
    print("Fixing timezone issues for correct candle display")
    print("=" * 60)
    ...
    visualizer = TradeVisualizerFixed(config)
    visualizer.generate_fixed_charts(max_trades=2)  # Start small for testing

if __name__ == "__main__":
    run_fixed_visualization()